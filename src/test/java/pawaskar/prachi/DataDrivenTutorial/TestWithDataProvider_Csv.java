...
import static pawaskar.prachi.DataDrivenTutorial.pages.Utils.readCsv;

public class TestWithDataProvider_Csv extends BaseTest {
    ...
    public static Object[][] credentials() throws IOException {
            return readCsv("src/main/resources/loginData.csv");
    }
